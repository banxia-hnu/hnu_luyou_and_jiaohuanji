...
# ----------------------------------------------------------------
	...
	set patterns [list]
	lappend patterns addrcmd ${instname}_alt_mem_phy_inst|*adc|*addr\[*\].addr_struct|*addr_pin|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns addrcmd ${instname}_alt_mem_phy_inst|*adc|*ba\[*\].ba_struct|*addr_pin|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns addrcmd ${instname}_alt_mem_phy_inst|*adc|*cas_n_struct|*addr_pin|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns addrcmd ${instname}_alt_mem_phy_inst|*adc|*ras_n_struct|*addr_pin|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns addrcmd ${instname}_alt_mem_phy_inst|*adc|*we_n_struct|*addr_pin|auto_generated|ddio_outa\[*\]|dataout
