# -------------------------------------------------------------------------
#
# ALTMEMPHY v12.0 DDR2 SDRAM pin constraints script for ddr2_12
#
...
set_instance_assignment -name XSTL_INPUT_ALLOW_SE_BUFFER "${mem_clk_XSTL_INPUT_ALLOW_SE_BUFFER}" -to ${mem_clk_pin_name}${single_bit}
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[0]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[1]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[2]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[3]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[4]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[5]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[6]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[7]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[8]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[9]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[10]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[11]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[12]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[13]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[14]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dq_pin_name}[15]
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dqs_pin_name}[0]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dqs_pin_name}[1]
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dqsn_pin_name}[0]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dqsn_pin_name}[1]
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dm_pin_name}[0]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "1525833792" -to ${mem_dm_pin_name}[1]
