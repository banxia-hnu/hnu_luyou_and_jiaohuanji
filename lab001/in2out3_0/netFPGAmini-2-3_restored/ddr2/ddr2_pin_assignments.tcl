# -------------------------------------------------------------------------
#
# ALTMEMPHY v10.0 DDR2 SDRAM pin constraints script for ddr2
#
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqsn_pin_name}[0]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "3078784" -to ${mem_dqsn_pin_name}[1]
