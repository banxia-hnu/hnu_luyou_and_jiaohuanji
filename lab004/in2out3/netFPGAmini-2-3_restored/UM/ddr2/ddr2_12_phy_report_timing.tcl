...
for {set inst_index 0} {$inst_index != [llength $instance_names]} {incr inst_index} {
	...
	if {$::dll_length == 0} {
		set ::dll_length 8
		if {[regexp "hardcopy" $family] > 0} {
			post_message -type critical_warning "Unable to determine DLL delay chain length, possibly due to the DQS delay chain being connected to a DLL on the opposite side of the device.  Assuming default setting of $::dll_length"
		} else {
